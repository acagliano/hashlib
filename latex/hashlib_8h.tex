...
\item 
\#define \mbox{\hyperlink{hashlib_8h_a19667e37a8544fc50aad7e4aa5e0f502}{AES\+\_\+\+MACSIZE}}~\mbox{\hyperlink{hashlib_8h_afab0742642db9c0609c00bf8a54f386f}{AES\+\_\+\+BLOCKSIZE}}
\item 
...
\item 
\#define \mbox{\hyperlink{hashlib_8h_a14743a93cbf9c7237d0ac03d842f296f}{hashlib\+\_\+\+AESAuth\+Mac\+Ciphertext\+Size}}(len)~ (\mbox{\hyperlink{hashlib_8h_a1bfa78156f62c2e87f7af3a8533304b1}{hashlib\+\_\+\+AESCiphertext\+IVSize}}((len)) + \mbox{\hyperlink{hashlib_8h_a19667e37a8544fc50aad7e4aa5e0f502}{AES\+\_\+\+MACSIZE}})
\item 
\#define \mbox{\hyperlink{hashlib_8h_a06773afe7f242955b6b668d2c3ea384a}{hashlib\+\_\+\+AESAuth\+Sha256\+Ciphertext\+Size}}(len)~ (\mbox{\hyperlink{hashlib_8h_a1bfa78156f62c2e87f7af3a8533304b1}{hashlib\+\_\+\+AESCiphertext\+IVSize}}((len)) + \mbox{\hyperlink{hashlib_8h_af5aa539ae202ddf9e0c9211309869fc8}{SHA256\+\_\+\+DIGEST\+\_\+\+LEN}})
\item 
...
bool \mbox{\hyperlink{hashlib_8h_ac48a46d4a3cd8338857b326c0342fb1d}{hashlib\+\_\+\+AESOutput\+Mac}} (const uint8\+\_\+t $\ast$buf, size\+\_\+t len, uint8\+\_\+t $\ast$mac, const \mbox{\hyperlink{hashlib_8h_aa188bc2768a3b7aa6ad73cb2c77819e0}{aes\+\_\+ctx}} $\ast$ks)
...
\begin{DoxyCompactList}\small\item\em Reverses the endianness of a buffer. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
Defines the length of the AES initalization vector (IV). \mbox{\Hypertarget{hashlib_8h_a19667e37a8544fc50aad7e4aa5e0f502}\label{hashlib_8h_a19667e37a8544fc50aad7e4aa5e0f502}} 
\index{hashlib.h@{hashlib.h}!AES\_MACSIZE@{AES\_MACSIZE}}
\index{AES\_MACSIZE@{AES\_MACSIZE}!hashlib.h@{hashlib.h}}
\doxysubsubsection{\texorpdfstring{AES\_MACSIZE}{AES\_MACSIZE}}
{\footnotesize\ttfamily \#define AES\+\_\+\+MACSIZE~\mbox{\hyperlink{hashlib_8h_afab0742642db9c0609c00bf8a54f386f}{AES\+\_\+\+BLOCKSIZE}}}

Defines the length of the AES CBC-\/\+MAC digest. \mbox{\Hypertarget{hashlib_8h_a2841462d8933d0982e3ea13dc5284d7c}\label{hashlib_8h_a2841462d8933d0982e3ea13dc5284d7c}} 
...
\hline
\end{DoxyParams}
\mbox{\Hypertarget{hashlib_8h_a14743a93cbf9c7237d0ac03d842f296f}\label{hashlib_8h_a14743a93cbf9c7237d0ac03d842f296f}} 
\index{hashlib.h@{hashlib.h}!hashlib\_AESAuthMacCiphertextSize@{hashlib\_AESAuthMacCiphertextSize}}
\index{hashlib\_AESAuthMacCiphertextSize@{hashlib\_AESAuthMacCiphertextSize}!hashlib.h@{hashlib.h}}
\doxysubsubsection{\texorpdfstring{hashlib\_AESAuthMacCiphertextSize}{hashlib\_AESAuthMacCiphertextSize}}
{\footnotesize\ttfamily \#define hashlib\+\_\+\+AESAuth\+Mac\+Ciphertext\+Size(\begin{DoxyParamCaption}\item[{}]{len }\end{DoxyParamCaption})~ (\mbox{\hyperlink{hashlib_8h_a1bfa78156f62c2e87f7af3a8533304b1}{hashlib\+\_\+\+AESCiphertext\+IVSize}}((len)) + \mbox{\hyperlink{hashlib_8h_a19667e37a8544fc50aad7e4aa5e0f502}{AES\+\_\+\+MACSIZE}})}

Defines a macro to return the size of an AES ciphertext with CBC-\/\+MAC authentication. This includes two extra blocks-\/ one for the IV and another for the MAC digest.
...
\hline
\end{DoxyParams}
\mbox{\Hypertarget{hashlib_8h_a06773afe7f242955b6b668d2c3ea384a}\label{hashlib_8h_a06773afe7f242955b6b668d2c3ea384a}} 
\index{hashlib.h@{hashlib.h}!hashlib\_AESAuthSha256CiphertextSize@{hashlib\_AESAuthSha256CiphertextSize}}
\index{hashlib\_AESAuthSha256CiphertextSize@{hashlib\_AESAuthSha256CiphertextSize}!hashlib.h@{hashlib.h}}
\doxysubsubsection{\texorpdfstring{hashlib\_AESAuthSha256CiphertextSize}{hashlib\_AESAuthSha256CiphertextSize}}
{\footnotesize\ttfamily \#define hashlib\+\_\+\+AESAuth\+Sha256\+Ciphertext\+Size(\begin{DoxyParamCaption}\item[{}]{len }\end{DoxyParamCaption})~ (\mbox{\hyperlink{hashlib_8h_a1bfa78156f62c2e87f7af3a8533304b1}{hashlib\+\_\+\+AESCiphertext\+IVSize}}((len)) + \mbox{\hyperlink{hashlib_8h_af5aa539ae202ddf9e0c9211309869fc8}{SHA256\+\_\+\+DIGEST\+\_\+\+LEN}})}

Defines a macro to return the size of an AES ciphertext with SHA-\/256 authentication. This includes one extra block for the IV and an additional 32 bytes for the SHA-\/256 digest.
...
\end{DoxyNote}
\begin{DoxyWarning}{Warning}
ECB-\/mode ciphers are insecure (see many-\/time pad vulnerability). These functions are exposed in case a user wants to construct a cipher mode other than CBC or CTR. Unless you know what you are doing, use \mbox{\hyperlink{hashlib_8h_aa4f60eb708a18d498faa51a33c248f90}{hashlib\+\_\+\+AESEncrypt()}} instead. 
\end{DoxyWarning}
\begin{DoxyReturn}{Returns}
...
\end{DoxyNote}
\begin{DoxyWarning}{Warning}
ECB-\/mode ciphers are insecure (see many-\/time pad vulnerability). These functions are exposed in case a user wants to construct a cipher mode other than CBC or CTR. Unless you know what you are doing, use \mbox{\hyperlink{hashlib_8h_a402aa47590cf2de4ea6cb2efba1fdb35}{hashlib\+\_\+\+AESDecrypt()}} instead. 
\end{DoxyWarning}
\begin{DoxyReturn}{Returns}
...
If cipher mode CBC is used, {\bfseries{len}} must be a multiple of the blocksize. You can pass the plaintext through \mbox{\hyperlink{hashlib_8h_aebac98a8537f3353aac9fbae5ed67f29}{hashlib\+\_\+\+AESPad\+Message()}} prior to calling this function. 
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{hashlib_8h_aa4f60eb708a18d498faa51a33c248f90}{hashlib\_AESEncrypt}}(plaintext, len, \&ciphertext[AES\_IV\_SIZE], ks, iv, <cipher\_mode>);}
...
True if the encryption succeded. False if an error occured. 
\end{DoxyReturn}
\mbox{\Hypertarget{hashlib_8h_ac48a46d4a3cd8338857b326c0342fb1d}\label{hashlib_8h_ac48a46d4a3cd8338857b326c0342fb1d}} 
...
{\footnotesize\ttfamily bool hashlib\+\_\+\+AESOutput\+Mac (\begin{DoxyParamCaption}\item[{const uint8\+\_\+t $\ast$}]{buf,  }\item[{size\+\_\+t}]{len,  }\item[{uint8\+\_\+t $\ast$}]{mac,  }\item[{const \mbox{\hyperlink{hashlib_8h_aa188bc2768a3b7aa6ad73cb2c77819e0}{aes\+\_\+ctx}} $\ast$}]{ks }\end{DoxyParamCaption})}
...
\hline
{\em len} & Length of data at {\bfseries{plaintext}} to generate a MAC for. \\
\hline
{\em mac} & Pointer to a buffer to write the MAC to. MAC must be at least {\bfseries{AES\+\_\+\+BLOCKSIZE}} bytes large. \\
\hline
{\em ks} & Pointer to a AES key schedule context. Must be different than the one used for encryption. \\
\hline
\end{DoxyParams}
\begin{DoxyNote}{Note}
...
To send a packet with authenticated encryption, you will need to append the MAC digest to your ciphertext returned by the above functions. For example, assuming {\bfseries{ciphertext}} is at least as large as the size returned by \mbox{\hyperlink{hashlib_8h_a14743a93cbf9c7237d0ac03d842f296f}{hashlib\+\_\+\+AESAuth\+Mac\+Ciphertext\+Size()}}\+: 
\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{hashlib_8h_aa4f60eb708a18d498faa51a33c248f90}{hashlib\_AESEncrypt}}(plaintext, len, \&ciphertext[AES\_IV\_SIZE], ks\_encrypt, iv, <ciphermode>);}
\DoxyCodeLine{memcpy(ciphertext, iv, AES\_IV\_SIZE);}
\DoxyCodeLine{\mbox{\hyperlink{hashlib_8h_ac48a46d4a3cd8338857b326c0342fb1d}{hashlib\_AESOutputMac}}(ciphertext, <padded\_len>, \&ciphertext[<padded\_len> + AES\_IV\_SIZE], ks\_auth);}
\DoxyCodeLine{\textcolor{comment}{// note the use of two different key schedules}}
