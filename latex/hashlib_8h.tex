...
\mbox{\hyperlink{hashlib_8h_aeb2e64abcc4317e3143fb820f21c3bfd}{aes\+\_\+error\+\_\+t}} \mbox{\hyperlink{hashlib_8h_a4f695c831642579cd415773036fd49b8}{hashlib\+\_\+\+AESAuth\+Decrypt}} (const uint8\+\_\+t $\ast$ciphertext, size\+\_\+t len, uint8\+\_\+t $\ast$plaintext, \mbox{\hyperlink{hashlib_8h_aa188bc2768a3b7aa6ad73cb2c77819e0}{aes\+\_\+ctx}} $\ast$key, const uint8\+\_\+t $\ast$iv, uint8\+\_\+t ciphermode, size\+\_\+t encryption\+\_\+offset, size\+\_\+t encryption\+\_\+len)
...
\end{DoxyNote}
\mbox{\Hypertarget{hashlib_8h_a4f695c831642579cd415773036fd49b8}\label{hashlib_8h_a4f695c831642579cd415773036fd49b8}} 
...
{\em ciphermode} & The cipher mode to use. Can be either {\itshape AES\+\_\+\+MODE\+\_\+\+CBC} or {\itshape AES\+\_\+\+MODE\+\_\+\+CTR}. \\
\hline
{\em encryption\+\_\+offset} & The offset from the start of the plaintext to begin decryption. This is useful if you have control bytes or metadata that should not be decrypted. \\
\hline
{\em encryption\+\_\+len} & The size of the data to be decrypted. This is useful if you have trailing bytes that should not be decrypted. \\
\hline
...
To decrypt the entire message, pass 0 for {\bfseries{encryption\+\_\+offset}} and {\bfseries{len}} for {\bfseries{encryption\+\_\+len}}. 
