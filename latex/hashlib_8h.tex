...
Defines a macro to return the padded size of an AES ciphertext. Does not include an IV-\/prepend. See \mbox{\hyperlink{hashlib_8h_a46100af2f9437a876f6a2d92d9db4369}{hashlib\+\_\+\+AESCiphertext\+IVLen()}} for that. \[ len = (len % AES_BLOCKSIZE) ? len + AES_BLOCKSIZE : ((len>>4) + 1)<<4; \] 
