...
\item 
\#define \mbox{\hyperlink{hashlib_8h_ab723a524d8d2149cb44285a8b8228f1f}{aes\+\_\+outsize}}(len)~ ((((len)\%\mbox{\hyperlink{hashlib_8h_afab0742642db9c0609c00bf8a54f386f}{AES\+\_\+\+BLOCKSIZE}})==0) ? (len) + \mbox{\hyperlink{hashlib_8h_afab0742642db9c0609c00bf8a54f386f}{AES\+\_\+\+BLOCKSIZE}} \+: (((len)$>$$>$4) + 1)$<$$<$4)
\item 
\#define \mbox{\hyperlink{hashlib_8h_a5441aa332bfebb52cb4480d5a0783334}{aes\+\_\+extoutsize}}(len)~ (\mbox{\hyperlink{hashlib_8h_ab723a524d8d2149cb44285a8b8228f1f}{aes\+\_\+outsize}}((len)) + \mbox{\hyperlink{hashlib_8h_a6c2d58d8dd281845fdc027b499dea89d}{AES\+\_\+\+IVSIZE}})
\end{DoxyCompactItemize}
...
\item 
typedef struct \mbox{\hyperlink{struct__sha256hmac__ctx}{\+\_\+sha256hmac\+\_\+ctx}} \mbox{\hyperlink{hashlib_8h_ab81b988d5afe79799b52a0baa55c3146}{sha256hmac\+\_\+ctx}}
\item 
...
void \mbox{\hyperlink{hashlib_8h_a6de2a3ef1df7da45fbe84b38f72baa71}{hash\+\_\+final}} (\mbox{\hyperlink{hashlib_8h_aa55779911de10df960d64966c6825da7}{hash\+\_\+ctx}} $\ast$ctx, void $\ast$digest)
\begin{DoxyCompactList}\small\item\em Finalize context and render digest for hash. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Context Initializer for HMAC. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Updates the hmac context for the given data. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Finalize Context and Render Digest for HMAC. \end{DoxyCompactList}\item 
...
Defines the length of the AES initalization vector (IV). \mbox{\Hypertarget{hashlib_8h_ab723a524d8d2149cb44285a8b8228f1f}\label{hashlib_8h_ab723a524d8d2149cb44285a8b8228f1f}} 
\index{hashlib.h@{hashlib.h}!aes\_outsize@{aes\_outsize}}
\index{aes\_outsize@{aes\_outsize}!hashlib.h@{hashlib.h}}
\doxysubsubsection{\texorpdfstring{aes\_outsize}{aes\_outsize}}
{\footnotesize\ttfamily \#define aes\+\_\+outsize(\begin{DoxyParamCaption}\item[{}]{len }\end{DoxyParamCaption})~ ((((len)\%\mbox{\hyperlink{hashlib_8h_afab0742642db9c0609c00bf8a54f386f}{AES\+\_\+\+BLOCKSIZE}})==0) ? (len) + \mbox{\hyperlink{hashlib_8h_afab0742642db9c0609c00bf8a54f386f}{AES\+\_\+\+BLOCKSIZE}} \+: (((len)$>$$>$4) + 1)$<$$<$4)}
...
\index{hashlib.h@{hashlib.h}!aes\_extoutsize@{aes\_extoutsize}}
\index{aes\_extoutsize@{aes\_extoutsize}!hashlib.h@{hashlib.h}}
\doxysubsubsection{\texorpdfstring{aes\_extoutsize}{aes\_extoutsize}}
{\footnotesize\ttfamily \#define aes\+\_\+extoutsize(\begin{DoxyParamCaption}\item[{}]{len }\end{DoxyParamCaption})~ (\mbox{\hyperlink{hashlib_8h_ab723a524d8d2149cb44285a8b8228f1f}{aes\+\_\+outsize}}((len)) + \mbox{\hyperlink{hashlib_8h_a6c2d58d8dd281845fdc027b499dea89d}{AES\+\_\+\+IVSIZE}})}
...
\end{DoxyNote}
\mbox{\Hypertarget{hashlib_8h_ab81b988d5afe79799b52a0baa55c3146}\label{hashlib_8h_ab81b988d5afe79799b52a0baa55c3146}} 
\index{hashlib.h@{hashlib.h}!sha256hmac\_ctx@{sha256hmac\_ctx}}
\index{sha256hmac\_ctx@{sha256hmac\_ctx}!hashlib.h@{hashlib.h}}
\doxysubsubsection{\texorpdfstring{sha256hmac\_ctx}{sha256hmac\_ctx}}
{\footnotesize\ttfamily \mbox{\hyperlink{hashlib_8h_ab81b988d5afe79799b52a0baa55c3146}{sha256hmac\+\_\+ctx}}}

Defines hash-\/state data for an instance of SHA-\/256. \begin{DoxyNote}{Note}
This is internal to the struct hmac\+\_\+ctx. You should never need to use this. 
\end{DoxyNote}
...
\end{DoxyParams}
\begin{DoxyNote}{Note}
You can use {\bfseries{ctx.\+update()}} as an alternative to this function. If doing so, you must pass {\bfseries{\&ctx.\+Hash}} instead of {\bfseries{\&ctx}}. 
\end{DoxyNote}
...
{\footnotesize\ttfamily void hash\+\_\+final (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{hashlib_8h_aa55779911de10df960d64966c6825da7}{hash\+\_\+ctx}} $\ast$}]{ctx,  }\item[{void $\ast$}]{digest }\end{DoxyParamCaption})}



Finalize context and render digest for hash. 
...
\end{DoxyParams}
\begin{DoxyNote}{Note}
{\bfseries{digest}} must be at large enough to hold the hash digest. 

You can use {\bfseries{ctx.\+final()}} as an alternative to this function. If doing so, you must pass {\bfseries{\&ctx.\+Hash}} instead of {\bfseries{\&ctx}}. 
\end{DoxyNote}
\begin{DoxyWarning}{Warning}
You must have an initialized hash context or a crash will ensue. 
\end{DoxyWarning}
...
Context Initializer for HMAC. 

Initializes the given context with the starting state for the given HMAC algorithm.


\begin{DoxyParams}{Parameters}
{\em ctx} & Pointer to a hmac context. \\
\hline
{\em key} & Pointer to an authentication key used to initialize the base hmac context. \\
\hline
...
Updates the hmac context for the given data. 


\begin{DoxyParams}{Parameters}
{\em ctx} & Pointer to an HMAC context. \\
\hline
{\em data} & Pointer to data to hash. \\
\hline
{\em len} & Number of bytes at {\bfseries{data}} to hash. \\
...
\end{DoxyParams}
\begin{DoxyNote}{Note}
You may use {\bfseries{ctx.\+update()}} as an alternative to this function. If doing so, you must pass {\bfseries{\&ctx.\+Hmac}} instead of {\bfseries{\&ctx}}. 
\end{DoxyNote}
\begin{DoxyWarning}{Warning}
You must have an initialized hash context or a crash will ensue. 
\end{DoxyWarning}
...
Finalize Context and Render Digest for HMAC. 
...
\end{DoxyParams}
\begin{DoxyNote}{Note}
{\bfseries{digest}} must be large enough to hold the hash digest. 

You may use {\bfseries{ctx.\+final()}} as an alternative to this function. If doing so, you must pass {\bfseries{\&ctx.\+Hmac}} instead of {\bfseries{\&ctx}}. 
\end{DoxyNote}
\begin{DoxyWarning}{Warning}
You must have an initialized hash context or a crash will ensue. 
\end{DoxyWarning}
