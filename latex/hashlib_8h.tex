...
bool \mbox{\hyperlink{hashlib_8h_a23f1805ae0c933e5565dfcc9c8e46d02}{hmac\+\_\+init}} (\mbox{\hyperlink{hashlib_8h_a8d813300476744f01319600478572f62}{hmac\+\_\+ctx}} $\ast$ctx, const void $\ast$key, size\+\_\+t keylen, uint8\+\_\+t alg)
...
bool \mbox{\hyperlink{hashlib_8h_a279fed67d31372b689f7b8b69035f9ca}{hmac\+\_\+pbkdf2}} (const char $\ast$password, size\+\_\+t passlen, void $\ast$key, size\+\_\+t keylen, const void $\ast$salt, size\+\_\+t saltlen, size\+\_\+t rounds, uint8\+\_\+t alg)
\begin{DoxyCompactList}\small\item\em Password-\/\+Based Key Derivation Function. \end{DoxyCompactList}\item 
bool \mbox{\hyperlink{hashlib_8h_a1e8fde09a695433599687e56310cb68a}{aes\+\_\+loadkey}} (const void $\ast$key, const \mbox{\hyperlink{hashlib_8h_aa188bc2768a3b7aa6ad73cb2c77819e0}{aes\+\_\+ctx}} $\ast$ks, size\+\_\+t keylen)
...
\mbox{\hyperlink{hashlib_8h_a0486449f609d0e485bad091a671d9294}{rsa\+\_\+error\+\_\+t}} \mbox{\hyperlink{hashlib_8h_a692de56123f350f0bf78ece7c4b67ac9}{rsa\+\_\+encrypt}} (const void $\ast$msg, size\+\_\+t msglen, void $\ast$ciphertext, const void $\ast$pubkey, size\+\_\+t keylen)
...
You must call \mbox{\hyperlink{hashlib_8h_ac97f2b17187bed64cb75d98ebb9184f8}{hash\+\_\+init()}} first or your hash state will be invalid. 
\end{DoxyWarning}
...
\end{DoxyNote}
\mbox{\Hypertarget{hashlib_8h_a23f1805ae0c933e5565dfcc9c8e46d02}\label{hashlib_8h_a23f1805ae0c933e5565dfcc9c8e46d02}} 
...
{\footnotesize\ttfamily bool hmac\+\_\+init (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{hashlib_8h_a8d813300476744f01319600478572f62}{hmac\+\_\+ctx}} $\ast$}]{ctx,  }\item[{const void $\ast$}]{key,  }\item[{size\+\_\+t}]{keylen,  }\item[{uint8\+\_\+t}]{alg }\end{DoxyParamCaption})}
...
\hline
{\em alg} & The hmac algorithm to use. See {\bfseries{hash\+\_\+algorithms}}. \\
\hline
\end{DoxyParams}
...
\end{DoxyNote}
\mbox{\Hypertarget{hashlib_8h_a279fed67d31372b689f7b8b69035f9ca}\label{hashlib_8h_a279fed67d31372b689f7b8b69035f9ca}} 
...
{\footnotesize\ttfamily bool hmac\+\_\+pbkdf2 (\begin{DoxyParamCaption}\item[{const char $\ast$}]{password,  }\item[{size\+\_\+t}]{passlen,  }\item[{void $\ast$}]{key,  }\item[{size\+\_\+t}]{keylen,  }\item[{const void $\ast$}]{salt,  }\item[{size\+\_\+t}]{saltlen,  }\item[{size\+\_\+t}]{rounds,  }\item[{uint8\+\_\+t}]{alg }\end{DoxyParamCaption})}
...
\hline
{\em alg} & The hmac algorithm to use for key generation. \\
\hline
\end{DoxyParams}
\begin{DoxyNote}{Note}
...
\end{DoxyNote}
\mbox{\Hypertarget{hashlib_8h_a1e8fde09a695433599687e56310cb68a}\label{hashlib_8h_a1e8fde09a695433599687e56310cb68a}} 
\index{hashlib.h@{hashlib.h}!aes\_loadkey@{aes\_loadkey}}
\index{aes\_loadkey@{aes\_loadkey}!hashlib.h@{hashlib.h}}
\doxysubsubsection{\texorpdfstring{aes\_loadkey()}{aes\_loadkey()}}
{\footnotesize\ttfamily bool aes\+\_\+loadkey (\begin{DoxyParamCaption}\item[{const void $\ast$}]{key,  }\item[{const \mbox{\hyperlink{hashlib_8h_aa188bc2768a3b7aa6ad73cb2c77819e0}{aes\+\_\+ctx}} $\ast$}]{ks,  }\item[{size\+\_\+t}]{keylen }\end{DoxyParamCaption})}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{cipher\_aes\_encrypt(plaintext, len, \&ciphertext[AES\_IV\_SIZE], ks, iv, <cipher\_mode>, <padding\_mode>);}
...
aes\+\_\+error\+\_\+t 
\end{DoxyReturn}
\mbox{\Hypertarget{hashlib_8h_a692de56123f350f0bf78ece7c4b67ac9}\label{hashlib_8h_a692de56123f350f0bf78ece7c4b67ac9}} 
...
{\footnotesize\ttfamily \mbox{\hyperlink{hashlib_8h_a0486449f609d0e485bad091a671d9294}{rsa\+\_\+error\+\_\+t}} rsa\+\_\+encrypt (\begin{DoxyParamCaption}\item[{const void $\ast$}]{msg,  }\item[{size\+\_\+t}]{msglen,  }\item[{void $\ast$}]{ciphertext,  }\item[{const void $\ast$}]{pubkey,  }\item[{size\+\_\+t}]{keylen }\end{DoxyParamCaption})}
