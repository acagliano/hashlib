...
The MAC is a tag equal in length to the AES block size computed by passing the plaintext through the CBC-\/\+MAC algorithm with a constant IV. \begin{DoxyVerb}@param plaintext Pointer to data to generate a MAC for.
