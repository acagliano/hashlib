...
\hline
{\em len} & Length of data at {\bfseries{plaintext}} to encrypt. This can be the output of hashlib\+\_\+\+AESCiphertext\+Len(). \\
\hline
...
{\bfseries{IV}} is not written to the ciphertext buffer by this function, only the encrypted message. However, if your ciphertext buffer is large enough, you can do the following to get the IV prepended to the ciphertext\+: 
\begin{DoxyCode}{0}
...
\end{DoxyCode}
 This will require a buffer at least as large as the size returned by hashlib\+\_\+\+AESCiphertext\+IVLen(). 
\end{DoxyNote}
\begin{DoxyReturn}{Returns}
