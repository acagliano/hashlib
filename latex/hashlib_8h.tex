...
\item 
\#define \mbox{\hyperlink{hashlib_8h_a5387d4504d29343ebd710ec09fde7aad}{AUTH\+\_\+\+SHA256\+\_\+\+LEN}}~\mbox{\hyperlink{hashlib_8h_af5aa539ae202ddf9e0c9211309869fc8}{SHA256\+\_\+\+DIGEST\+\_\+\+LEN}}
\begin{DoxyCompactList}\small\item\em Authenticated Encryption Scheme Guidelines. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\end{DoxyReturn}
\mbox{\Hypertarget{hashlib_8h_a5387d4504d29343ebd710ec09fde7aad}\label{hashlib_8h_a5387d4504d29343ebd710ec09fde7aad}} 
\index{hashlib.h@{hashlib.h}!AUTH\_SHA256\_LEN@{AUTH\_SHA256\_LEN}}
\index{AUTH\_SHA256\_LEN@{AUTH\_SHA256\_LEN}!hashlib.h@{hashlib.h}}
\doxysubsubsection{\texorpdfstring{AUTH\_SHA256\_LEN}{AUTH\_SHA256\_LEN}}
{\footnotesize\ttfamily \#define AUTH\+\_\+\+SHA256\+\_\+\+LEN~\mbox{\hyperlink{hashlib_8h_af5aa539ae202ddf9e0c9211309869fc8}{SHA256\+\_\+\+DIGEST\+\_\+\+LEN}}}



Authenticated Encryption Scheme Guidelines. 

Authenticated encryption is the process of attaching a means of detecting data tampering to an encryption algorithm to ensure integrity as well as confidentiality. Authentication usually involves a hash or signature appended to the ciphertext. There is no provided authenticated encryption implementation in this library because it is dependent on the protocol used, but you can use the included SHA-\/256 implementation as a means of validation.

\begin{DoxyNote}{Note}
Hash the data you will be transmitting {\bfseries{AFTER}} encryption, not before. 

Hash both encrypted and unencrypted parts of your packet. 

Append the hash to the ciphertext before transmitting. 

The same guidelines apply to both AES and RSA. 
\end{DoxyNote}
\begin{DoxyWarning}{Warning}
When decrypting, {\bfseries{validate the hash first}}. If the hash is invalid, do not decrypt the message. 
\end{DoxyWarning}
