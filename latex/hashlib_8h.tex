...
bool {\bfseries hashlib\+\_\+\+RSAEncrypt} (uint8\+\_\+t $\ast$ciphertext, const uint8\+\_\+t $\ast$msg, size\+\_\+t msglen, const uint8\+\_\+t $\ast$pubkey, size\+\_\+t keylen)
\item 
...
bool {\bfseries hashlib\+\_\+\+Reverse\+Endianness} (const uint8\+\_\+t $\ast$in, uint8\+\_\+t $\ast$out, size\+\_\+t len)
\end{DoxyCompactItemize}
