...
\item 
\mbox{\Hypertarget{hashlib_8h_a45ad76689980a12e8a5453a413f670c8}\label{hashlib_8h_a45ad76689980a12e8a5453a413f670c8}} 
\#define {\bfseries cipher\+\_\+aes\+\_\+outsize}(len)~ ((((len)\%\mbox{\hyperlink{hashlib_8h_afab0742642db9c0609c00bf8a54f386f}{AES\+\_\+\+BLOCKSIZE}})==0) ? (len) + \mbox{\hyperlink{hashlib_8h_afab0742642db9c0609c00bf8a54f386f}{AES\+\_\+\+BLOCKSIZE}} \+: (((len)$>$$>$4) + 1)$<$$<$4)
\item 
\mbox{\Hypertarget{hashlib_8h_a1da7be2f0eebec1e53e411fc0cc183fb}\label{hashlib_8h_a1da7be2f0eebec1e53e411fc0cc183fb}} 
\#define {\bfseries cipher\+\_\+aes\+\_\+extoutsize}(len)~ (cipher\+\_\+aes\+\_\+outsize((len)) + \mbox{\hyperlink{hashlib_8h_a6c2d58d8dd281845fdc027b499dea89d}{AES\+\_\+\+IVSIZE}})
\end{DoxyCompactItemize}
...
bool \mbox{\hyperlink{hashlib_8h_ac87c4b048460858ea689e6a610ea6055}{digest\+\_\+fromstring}} (const void $\ast$digest, size\+\_\+t len, char $\ast$hexstr)
...
\begin{DoxyItemize}
\item Calls hashlib\+\_\+\+SPRNGInit() if it hasn\textquotesingle{}t already been done.
...
\end{DoxyParams}
\begin{DoxyWarning}{Warning}
You must call hashlib\+\_\+\+HMACSha256\+Init() first or your hash state will be invalid. 
\end{DoxyWarning}
...
\end{DoxyCode}
 This will require a buffer at least as large as the size returned by hashlib\+\_\+\+AESCiphertext\+IVSize(). 
\end{DoxyNote}
\begin{DoxyReturn}{Returns}
aes\+\_\+error\+\_\+t 
\end{DoxyReturn}
...
rsa\+\_\+error\+\_\+t 
\end{DoxyReturn}
\mbox{\Hypertarget{hashlib_8h_ac87c4b048460858ea689e6a610ea6055}\label{hashlib_8h_ac87c4b048460858ea689e6a610ea6055}} 
\index{hashlib.h@{hashlib.h}!digest\_fromstring@{digest\_fromstring}}
\index{digest\_fromstring@{digest\_fromstring}!hashlib.h@{hashlib.h}}
\doxysubsubsection{\texorpdfstring{digest\_fromstring()}{digest\_fromstring()}}
{\footnotesize\ttfamily bool digest\+\_\+fromstring (\begin{DoxyParamCaption}\item[{const void $\ast$}]{digest,  }\item[{size\+\_\+t}]{len,  }\item[{char $\ast$}]{hexstr }\end{DoxyParamCaption})}
