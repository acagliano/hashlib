...
\begin{DoxyCompactList}\small\item\em Advanced Encryption Standard (AES) Implementation. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\item 
\mbox{\Hypertarget{hashlib_8h_a9773c988164a4adc0e7b20dddac1bff4}\label{hashlib_8h_a9773c988164a4adc0e7b20dddac1bff4}} 
\#define {\bfseries hashlib\+\_\+\+Fast\+Mem\+Buffer\+Un\+Safe}~((void$\ast$)0x\+E30800)
\item 
...
\item 
typedef struct \mbox{\hyperlink{struct__aes__ctx}{\+\_\+aes\+\_\+ctx}} \mbox{\hyperlink{hashlib_8h_a65315f1d62f11ec21b75450e86ce9774}{aes\+\_\+ctx}}
\begin{DoxyCompactList}\small\item\em Advanced Encryption Standard (AES) Implementation. \end{DoxyCompactList}\end{DoxyCompactItemize}
\doxysubsection*{Enumerations}
\begin{DoxyCompactItemize}
\item 
\mbox{\Hypertarget{hashlib_8h_a194ef6b5934dff6dceed4dd819e76340}\label{hashlib_8h_a194ef6b5934dff6dceed4dd819e76340}} 
enum \mbox{\hyperlink{hashlib_8h_a194ef6b5934dff6dceed4dd819e76340}{aes\+\_\+cipher\+\_\+modes}} \{ {\bfseries AES\+\_\+\+MODE\+\_\+\+CBC}
, {\bfseries AES\+\_\+\+MODE\+\_\+\+CTR}
 \}
\begin{DoxyCompactList}\small\item\em AES cipher modes. \end{DoxyCompactList}\item 
...
, \mbox{\hyperlink{hashlib_8h_a9933dec76c43b37331782bdd16ebc4a3a030a31bd034c7d20a80341ede899a6b7}{SCHM\+\_\+\+ISO2}}
 \}
\begin{DoxyCompactList}\small\item\em AES padding schemes. \end{DoxyCompactList}\item 
...
, {\bfseries SSLSIG\+\_\+\+ECDSA}
 \}
\begin{DoxyCompactList}\small\item\em RSA Pubkey and SSL Verification Implementation. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
bool \mbox{\hyperlink{hashlib_8h_a0653a6a286fb1bedfb3e964d36e3b0bd}{hashlib\+\_\+\+AESLoad\+Key}} (const uint8\+\_\+t $\ast$key, const \mbox{\hyperlink{hashlib_8h_a65315f1d62f11ec21b75450e86ce9774}{aes\+\_\+ctx}} $\ast$ks, size\+\_\+t keylen)
\begin{DoxyCompactList}\small\item\em AES import key to key schedule context. \end{DoxyCompactList}\item 
bool \mbox{\hyperlink{hashlib_8h_a6987499522b3b85b8ce4b272fadf75dd}{hashlib\+\_\+\+AESEncrypt\+Block}} (const uint8\+\_\+t $\ast$block\+\_\+in, uint8\+\_\+t $\ast$block\+\_\+out, const \mbox{\hyperlink{hashlib_8h_a65315f1d62f11ec21b75450e86ce9774}{aes\+\_\+ctx}} $\ast$ks)
\begin{DoxyCompactList}\small\item\em AES Single-\/\+Block Encryption (ECB mode) \end{DoxyCompactList}\item 
bool \mbox{\hyperlink{hashlib_8h_a5dd423839387f0955b6061986c92a2ac}{hashlib\+\_\+\+AESDecrypt\+Block}} (const uint8\+\_\+t $\ast$block\+\_\+in, uint8\+\_\+t $\ast$block\+\_\+out, const \mbox{\hyperlink{hashlib_8h_a65315f1d62f11ec21b75450e86ce9774}{aes\+\_\+ctx}} $\ast$ks)
\begin{DoxyCompactList}\small\item\em AES Single-\/\+Block Decryption (ECB Mode) \end{DoxyCompactList}\item 
bool \mbox{\hyperlink{hashlib_8h_a745c5c4d6bdc248f20b18c7b848d8b6b}{hashlib\+\_\+\+AESEncrypt}} (const uint8\+\_\+t $\ast$plaintext, size\+\_\+t len, uint8\+\_\+t $\ast$ciphertext, const \mbox{\hyperlink{hashlib_8h_a65315f1d62f11ec21b75450e86ce9774}{aes\+\_\+ctx}} $\ast$ks, const uint8\+\_\+t $\ast$iv, uint8\+\_\+t ciphermode)
\begin{DoxyCompactList}\small\item\em AES Encryptor Function. \end{DoxyCompactList}\item 
bool \mbox{\hyperlink{hashlib_8h_a2b904b543405fdf8f283d028ce0d1da7}{hashlib\+\_\+\+AESDecrypt}} (const uint8\+\_\+t $\ast$ciphertext, size\+\_\+t len, uint8\+\_\+t $\ast$plaintext, const \mbox{\hyperlink{hashlib_8h_a65315f1d62f11ec21b75450e86ce9774}{aes\+\_\+ctx}} $\ast$ks, const uint8\+\_\+t $\ast$iv, uint8\+\_\+t ciphermode)
\begin{DoxyCompactList}\small\item\em AES Decryptor Function. \end{DoxyCompactList}\item 
bool \mbox{\hyperlink{hashlib_8h_a6ca5ecde1fd675effbc4a29eac35a903}{hashlib\+\_\+\+AESOutput\+Mac}} (const uint8\+\_\+t $\ast$plaintext, size\+\_\+t len, uint8\+\_\+t $\ast$mac, const \mbox{\hyperlink{hashlib_8h_a65315f1d62f11ec21b75450e86ce9774}{aes\+\_\+ctx}} $\ast$ks)
...
Temporary memory buffer. Must be passed to \mbox{\hyperlink{hashlib_8h_ad2fa6bc8d3a1156a5734b81f5195afc4}{hashlib\+\_\+\+Sha256\+Init()}}. 
...
{\footnotesize\ttfamily typedef struct \mbox{\hyperlink{struct__aes__ctx}{\+\_\+aes\+\_\+ctx}} \mbox{\hyperlink{hashlib_8h_a65315f1d62f11ec21b75450e86ce9774}{aes\+\_\+ctx}}}
...
RSA Pubkey and SSL Verification Implementation. 

work-\/in-\/progress supports modulus size from 1024 to 2048 bits public exponent e = 65537, hardcoded

For compatibility with server-\/side decryption/decode, please make sure your encoding algorithm specs on the host match those hardcoded by this library.
\begin{DoxyItemize}
\item Hashing oracle where applicable\+: SHA-\/256.
\item Mask Generation Function where applicable\+: MGF1, using SHA-\/256 SSL Signature Algorithms 
\end{DoxyItemize}\mbox{\Hypertarget{hashlib_8h_a9933dec76c43b37331782bdd16ebc4a3}\label{hashlib_8h_a9933dec76c43b37331782bdd16ebc4a3}} 
...
{\footnotesize\ttfamily bool hashlib\+\_\+\+AESDecrypt\+Block (\begin{DoxyParamCaption}\item[{const uint8\+\_\+t $\ast$}]{block\+\_\+in,  }\item[{uint8\+\_\+t $\ast$}]{block\+\_\+out,  }\item[{const \mbox{\hyperlink{hashlib_8h_a65315f1d62f11ec21b75450e86ce9774}{aes\+\_\+ctx}} $\ast$}]{ks }\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily bool hashlib\+\_\+\+AESEncrypt\+Block (\begin{DoxyParamCaption}\item[{const uint8\+\_\+t $\ast$}]{block\+\_\+in,  }\item[{uint8\+\_\+t $\ast$}]{block\+\_\+out,  }\item[{const \mbox{\hyperlink{hashlib_8h_a65315f1d62f11ec21b75450e86ce9774}{aes\+\_\+ctx}} $\ast$}]{ks }\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily bool hashlib\+\_\+\+AESLoad\+Key (\begin{DoxyParamCaption}\item[{const uint8\+\_\+t $\ast$}]{key,  }\item[{const \mbox{\hyperlink{hashlib_8h_a65315f1d62f11ec21b75450e86ce9774}{aes\+\_\+ctx}} $\ast$}]{ks,  }\item[{size\+\_\+t}]{keylen }\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily bool hashlib\+\_\+\+AESOutput\+Mac (\begin{DoxyParamCaption}\item[{const uint8\+\_\+t $\ast$}]{plaintext,  }\item[{size\+\_\+t}]{len,  }\item[{uint8\+\_\+t $\ast$}]{mac,  }\item[{const \mbox{\hyperlink{hashlib_8h_a65315f1d62f11ec21b75450e86ce9774}{aes\+\_\+ctx}} $\ast$}]{ks }\end{DoxyParamCaption})}
...
$\vert$ $<$-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/--- modulus size -\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/---$>$ $\vert$ ~\newline
$\vert$-- 0x00 --$\vert$-- salt --$\vert$-- auth hash --$\vert$-- 0x00...padding --$\vert$-- 0x01 --$\vert$-- message --$\vert$ ~\newline
 $\vert$ $\vert$-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/---$\vert$-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/---$\vert$ ~\newline
 $\vert$ $\vert$ ~\newline
 $\vert$ -\/-\/-\/-\/-\/--- MGF1-\/\+SHA256 -\/-\/-\/-\/---$>$ XOR ~\newline
 $\vert$ $\vert$ ~\newline
 XOR $<$-\/-\/-\/-\/-\/--- MGF1-\/\+SHA256 -\/-\/-\/-\/-\/-\/---$\vert$ ~\newline
 $\vert$ $\vert$ ~\newline
$\vert$-- 0x00 --$\vert$-\/ msalt -\/$\vert$-\/-\/-\/-\/-\/--- masked message, padding, and auth hash -\/-\/-\/-\/-\/---$\vert$ ~\newline
$\vert$$<$-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/--- modulus size -\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/---$>$ $\vert$ ~\newline
...
$\vert$-\/-\/--- Message -\/-\/---$\vert$ -\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/--- SHA-\/256 -\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/---$>$$\vert$ ~\newline
 $\vert$ ~\newline
$\vert$-- 0x00... padding --$\vert$-- 0x01 --$\vert$-- salt --$\vert$ $\vert$-- 8 bytes 0x00 --$\vert$-- m\+Hash --$\vert$-- salt --$\vert$ ~\newline
$\vert$-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/---$\vert$ $\vert$-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/---$\vert$ ~\newline
 $\ast$\+DB $\vert$ $\ast$M\textquotesingle{} $\vert$ ~\newline
 $\vert$ SHA-\/256 ~\newline
 XOR $<$-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/--- MGF1-\/\+SHA256 -\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/---$\vert$ ~\newline
 $\vert$ $\vert$ ~\newline
 $\vert$ $<$ -\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/--- $\vert$ ~\newline
 $\vert$ $\vert$ ~\newline
$\vert$-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/--- masked DB -\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/---$\vert$-- M\textquotesingle{} Hash --$\vert$-- 0xbc --$\vert$ ~\newline
$\vert$-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/--- modulus size -\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/---$\vert$ ~\newline
...
\end{DoxyParams}
\begin{DoxyNote}{Note}
\#digest must be at least 32 bytes large. 
\end{DoxyNote}
...
\end{DoxyParams}
\begin{DoxyNote}{Note}
\#mbuffer must be at least \mbox{\hyperlink{hashlib_8h_a939c5eb79064fb776e34fd0c632a588b}{SHA256\+\_\+\+MBUFFER\+\_\+\+LEN}} bytes large. 
\end{DoxyNote}
...
\hypertarget{hashlib_8h_autotoc_md0}{}\doxysubsection{Secure Psuedorandom Number Generator (\+SPRNG)}\label{hashlib_8h_autotoc_md0}
An entropy-\/based, non-\/deterministic secure PRNG. Generates 96.\+51 bits of entropy per 32-\/bit number generated
